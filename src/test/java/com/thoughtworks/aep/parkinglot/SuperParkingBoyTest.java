...
public class SuperParkingBoyTest {
    ...
    public void test_should_return_ticket_when_park_given_one_lot_with_one_capacity() {
        ...
        ParkingBoy parkingBoy = new SuperParkingBoy(Collections.singletonList(parkingA));
    ...
    @Test
    public void test_should_park_into_first_lots_when_park_given_two_lots_and_first_capacity_rate_more_than_second() {
        ParkingLot firstPark = new ParkingLot("firstPark", 3);
        ParkingLot secondPark = new ParkingLot("secondPark", 2);
        List<ParkingLot> parkingLots = Arrays.asList(firstPark, secondPark);
        ParkingBoy parkingBoy = new SuperParkingBoy(parkingLots);

        firstPark.park(new Car("A111111"));
        secondPark.park(new Car("A222222"));
    ...
    @Test
    public void test_should_park_into_second_lots_when_park_given_two_lots_and_second_capacity_rate_more_than_first() {
        ParkingLot firstPark = new ParkingLot("firstPark", 2);
    ...
    @Test
    public void test_should_alternative_park_into_lots_when_park_given_two_lots_with_same_capacity_rate() {
        ParkingLot firstPark = new ParkingLot("firstPark", 3);
        ParkingLot secondPark = new ParkingLot("secondPark", 3);
        List<ParkingLot> parkingLots = Arrays.asList(firstPark, secondPark);
        ParkingBoy parkingBoy = new SuperParkingBoy(parkingLots);
    ...
    public void test_should_raise_exception_when_pick_given_invalid_ticket() {
        ...
        ParkingBoy parkingBoy = new SuperParkingBoy(Arrays.asList(firstPark, secondPark));
